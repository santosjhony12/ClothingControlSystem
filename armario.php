...
<body>
  ...
  <script src="mobile-navbar.js"></script>
        ...
        <h1 style="font-weight:bold; font-size: 2em">Selecione o departamento:</h1><br>
        <a href="armarioBox.php" ><button class="btnAdv">Box</button>
        </a>
        
            <a href="armarioLehr.php" ><button class="btnAdv">Lehr</button>
            </a>
        <a href="armarioTanglass.php" ><button class="btnAdv">Tanglass</button>
        </a>
        </div>
