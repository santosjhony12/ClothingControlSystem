...
echo '
                ...
                <h1 class="w3-center w3-round-large w3-margin" style="background: #007BFF; color: white" >Armário Box</h1>
                ...
                <thead>
                ';
                $sql = "SELECT * FROM armario WHERE depart = '1' ORDER BY tipo asc";
