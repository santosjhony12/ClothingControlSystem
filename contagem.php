...
<body>
  ...
  <script src="mobile-navbar.js"></script>
        ...
        <div class="w3-container">
            ...
            <form method="get" action="contarAction.php" class="edicao">
                <h1 style="font-weight:bold; font-size: 1.5em">Contar Lançamentos</h1><br>
    ...
    <label for="movimento">Saída</label><br><br>
                ...
                <button name="btnAdicionar" class="btnAdd w3-left"> 
                    <i class="w3-xxlarge fa fa-search"></i> Contar
                </button>
            </form>
