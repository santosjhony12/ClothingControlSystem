...
<h1 style="font-weight:bold; font-size: 2em; text-align:center">Lançamento LEHR</h1><br>
        <form method="post" action="lancamentoActionlehr.php">
...
<form method="post" action="lancamentoActionlehr.php" class="w3-hide-large w3-hide-medium edicao">
    <h1 style="font-weight:bold; font-size: 1.5em">Lançamento LEHR</h1><br> 
