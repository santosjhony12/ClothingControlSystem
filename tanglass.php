...
<h1 style="font-weight:bold; font-size: 2em; text-align:center">Lançamento Tanglass</h1><br>
        <form method="post" action="lancamentoActiontanglass.php">
...
<form method="post" action="LANCAMENTO/lancamentoActiontanglass.php" class="w3-hide-large w3-hide-medium edicao">
    <h1 style="font-weight:bold; font-size: 1.5em">Lançamento TANGLASS</h1><br> 
